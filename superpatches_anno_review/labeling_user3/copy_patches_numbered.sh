...
in_dir=/nfs/data04/shared/shahira/generate_superpatches/super_patches_0_groups/user_3/
out_dir=/nfs/data04/shared/shahira/superpatch_labeling/infiltration_rate_labeling_user3/
