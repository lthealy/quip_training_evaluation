...
in_dir=/nfs/data04/shared/shahira/generate_superpatches/super_patches_0_groups/user_1/
out_dir=/nfs/data04/shared/shahira/superpatch_labeling/labeling_user1/
